...
export const OffersView: React.FC<OffersViewProps> = ({
  ...
  const categories = [
    { id: 'all', label: 'الكل' },
    { id: 'medical_devices', label: 'أجهزة ومستلزمات طبية', icon: HeartPulse },
    { id: 'travel', label: 'طيران ومواصلات', icon: Plane },
    { id: 'health', label: 'صحة وتأهيل', icon: HeartPulse },
    { id: 'hotels', label: 'فنادق وإقامة', icon: Hotel },
    { id: 'shopping', label: 'تسوق وقسائم', icon: ShoppingBag },
    { id: 'cafes', label: 'مطاعم وكافيهات', icon: Coffee },
  ];
  ...
  return (
    <div id="mueeni-offers-screen" className="space-y-5 pb-24 animate-fade-in">
      {/* Header Banner */}
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <h1 className="text-2xl font-black text-white mt-1">
              بوابة الخدمات والخصومات
            </h1>
            <p className="text-xs text-emerald-100 mt-1 max-w-md leading-relaxed">
              خصومات وتسهيلات حصرية مخصصة لمستفيدي مُعِيني لدى شركائنا في جميع مناطق المملكة.
            </p>
          </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="flex items-center gap-1.5">
              ...
              <h3 className="text-sm font-black text-white">مبادرة السبت البنفسجي</h3>
            </div>
            <p className="text-xs text-purple-200 mt-0.5">
              تخفيضات تصل حتى 70% كل سبت من شهر يوليو
            </p>
          </div>
        </div>
      ...
      <div className="relative flex items-center">
        ...
        <input
          ...
          type="text"
          placeholder="ابحث عن متجر، كافيه، فندق، أو كود خصم..."
          value={searchQuery}
          ...
          <div className="w-full max-w-md bg-white rounded-3xl shadow-2xl border border-slate-200 overflow-hidden flex flex-col">
            ...
            <div className="relative h-36 bg-slate-100">
              ...
              <button
                ...
                className="absolute top-3 left-3 w-8 h-8 rounded-full bg-slate-900/60 text-white hover:bg-slate-900 flex items-center justify-center"
              >
                <X className="w-4 h-4" />
              </button>
              <div className="absolute bottom-3 right-3 bg-rose-600 text-white font-black text-xs px-3 py-1 rounded-full shadow-md">
                خصم {activeOfferModal.discount}
              </div>
            </div>
              ...
              <div className="p-4 rounded-2xl bg-emerald-50 border-2 border-dashed border-emerald-300 space-y-2">
                ...
                {copiedCode && (
                  <span className="text-[11px] font-bold text-emerald-700 block animate-fade-in">
                    تم نسخ الكود بنجاح! يمكنك استخدامه في موقع أو فرع المتجر.
                  </span>
                )}
              </div>

              <div className="text-[11px] text-slate-400 space-y-0.5">
                <p>صالح لجميع مستفيدي بطاقات مُعِيني AI</p>
                <p>تاريخ الصلاحية حتى: {activeOfferModal.validUntil}</p>
              </div>
            </div>
