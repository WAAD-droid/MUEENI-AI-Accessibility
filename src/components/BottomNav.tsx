...
export const BottomNav: React.FC<BottomNavProps> = ({
  ...
  const beneficiaryNavItems = [
    { id: 'assistant', label: 'المستشار الذكي', icon: Sparkles },
    { id: 'jobs', label: 'الوظائف والتدريب', icon: Briefcase },
    { id: 'home', label: 'الرئيسية', icon: Home },
    { id: 'reports', label: 'البلاغات الذكية', icon: MessageSquareWarning },
    { id: 'offers', label: 'الخدمات والخصومات', icon: Tag },
  ];

  // 2. Service Provider Navigation Items: Profile, Services, Home (Center), Campaigns, Analytics
  const providerNavItems = [
    { id: 'provider_profile', label: 'الملف التعريفي', icon: User },
    { id: 'provider_services', label: 'الخدمات', icon: Tag },
    { id: 'provider_home', label: 'الرئيسية', icon: Home },
    { id: 'provider_campaigns', label: 'الحملات', icon: Flame },
    { id: 'provider_analytics', label: 'الإحصائيات', icon: BarChart3 },
  ];
  ...
  return (
    <nav
      ...
      aria-label="شريط التنقل السفلي الرئيسي"
