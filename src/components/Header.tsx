  ...
  return (
    ...
    >
      <div className="max-w-4xl mx-auto flex items-center justify-between gap-2">
        {/* Right in RTL (Start): Back button or Main Logo */}
        <div className="flex items-center gap-2.5 min-w-0">
          {showBack ? (
            ...
            >
              <Logo size="sm" horizontal showSubtitle={false} />
            </div>
          )}
        ...
        {/* Left in RTL (End): Actions & Profile */}
        <div className="flex items-center gap-1.5 sm:gap-2 shrink-0">
          ...
          {onToggleLanguage && (
            <button
              ...
              aria-label="التبديل إلى اللغة الإنجليزية"
          ...
          {onToggleScreenReader && (
            <button
              id="header-quick-voice-btn"
              onClick={onToggleScreenReader}
              title={screenReaderActive ? 'إيقاف القارئ الصوتي' : 'تشغيل القارئ الصوتي'}
              aria-label="تبديل القارئ الصوتي"
          ...
          {onToggleRole && (
            <button
              ...
              aria-label="تبديل البوابة بين المستفيد ومقدم الخدمة"
          ...
          <button
            ...
            aria-label="فتح لوحة إعدادات سهولة الوصول"
          ...
          >
            ...
            <span className="hidden sm:inline">سهولة الوصول</span>
          </button>

          {/* Top-Left: "معلوماتي" Dedicated Profile Button */}
          <button
            ...
            aria-label="الانتقال إلى صفحتي ومعلوماتي الشخصية"
          ...
          >
            ...
            <span className="whitespace-nowrap">معلوماتي</span>
          </button>
        </div>
      </div>
    </header>
